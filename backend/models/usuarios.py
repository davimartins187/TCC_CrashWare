...
class Usuarios(Base):
    ...
    #nivel_id
    def __init__(self,nome_usuario,email,senha_hash,telefone = None,foto = 'default.png',banner="default.png",email_verificado=False,ativo=True,admin=False,coin=0,xp = 0,codigo = codigo, codigo_expirado_em = codigo_expirado_em):
